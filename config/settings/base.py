...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-t)w%&*urm365l@nd#^8uf4-%myg#(et##*v^r!ov-3d=s=@y85')
...
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'apps.core.paginators.StandardResultsSetPagination',
}
